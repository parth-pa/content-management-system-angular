...
export class MobileComponent implements OnInit {
  ...
  mobileList:dataList[] = [
    ...
    //  {id:1, heading:'mobile_1',image:this.imgs,detail:'details...1'},
    //  {id:2, heading:'mobile_2',image:this.imgs,detail:'details...2'},
    //  {id:3, heading:'mobile_3',image:this.imgs,detail:'details...3'},
