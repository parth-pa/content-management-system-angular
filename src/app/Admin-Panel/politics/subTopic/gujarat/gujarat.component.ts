...
export class GujaratComponent implements OnInit{
  ...
  gujaratList:dataList[] = [

    //  {id:1, heading:'gujarat_1',image:this.imgs,detail:'details...1'},
    //  {id:2, heading:'gujarat_2',image:this.imgs,detail:'details...2'},
    //  {id:3, heading:'gujarat_3',image:this.imgs,detail:'details...3'},
