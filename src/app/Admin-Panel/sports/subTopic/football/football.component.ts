...
export class FootballComponent implements OnInit{
  ...
  footballList:dataList[] = [

    //  {id:1, heading:'football_1',image:this.imgs,detail:'details...1'},
    //  {id:2, heading:'football_2',image:this.imgs,detail:'details...2'},
    //  {id:3, heading:'football_3',image:this.imgs,detail:'details...3'},
